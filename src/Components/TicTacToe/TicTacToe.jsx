...
import circle_icon from "../../Components/Assets/o.png";
import cross_icon from "../../Components/Assets/x.png";
...
const TicTacToe = () => {
  ...
  let boxe_array = [box1, box2, box3, box4, box5, box6, box7, box8, box9];
